                ...
                <div className={s.bodyBlock}>
                    ...
                    <div className={s.whatYouGetItems}>
                        ...
                        <div className={s.whatYouGetItem}>
                            ...
                            <p className={s.whatYouGetText}>
                                Мы обеспечиваем индивидуальный подход к каждому ученику при подготовке к интервью, исправляем
                                недоработки, отрабатываем весь необходимый материал для получения наиболее выгодного
